...
class PressCategory extends Model
{
     ...
     */
    public $table = 'abnmt_theater_press_categories';
    ...
    public $belongsToMany = [
        'press' => ['Abnmt\Theater\Models\Press', 'table' => 'abnmt_theater_press_articles_categories', 'order' => 'published_at desc', 'scope' => 'isPublished']
    ];
    public $morphTo = [];
    public $morphOne = [];
    public $morphMany = [];
    ...
    public static function getMenuTypeInfo($type)
    {
        ...
        if ($result) {
            ...
            foreach ($pages as $page) {
                if (!$page->hasComponent('theaterPress'))
                    continue;
    ...
    public static function resolveMenuItem($item, $url, $theme)
    {
        ...
        elseif ($item->type == 'all-press-categories') {
            $result = [
                'items' => []
            ];
    ...
    protected static function getCategoryPageUrl($pageCode, $category, $theme)
    {
        ...
        $properties = $page->getComponentProperties('theaterPress');
